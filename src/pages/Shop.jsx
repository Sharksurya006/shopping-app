...
export default function Shop() {
	const { category } = useParams(); const [all, setAll] = useState(null), [err, setErr] = useState(false), [fab, setFab] = useState([]), [max, setMax] = useState(15000), [sort, setSort] = useState('rec'), [grid, setGrid] = useState(true), [page, setPage] = useState(1), [fopen, setFopen] = useState(false);
